...
const RECIPES := {
	...
	"bow": {"name": "Лук", "desc": "Стреляет далеко, урон по животным", "cost": {"wood": 6, "stone": 1}, "tool": true},
	"crossbow": {"name": "Арбалет", "desc": "Мощный выстрел на дистанции", "cost": {"wood": 8, "stone": 4, "sulfur": 2}, "tool": true},
	...
	"stone_bow": {"name": "Каменный лук", "desc": "Дальний бой, больше урона", "cost": {"wood": 8, "stone": 6}, "tool": true},
	"stone_crossbow": {"name": "Каменный арбалет", "desc": "Мощный дальний бой", "cost": {"wood": 10, "stone": 8, "sulfur": 4}, "tool": true},
